...
- (void)performBatchUpdates:(void (^)())updates completion:(void (^)())completionHandler;
...
- (void)updateLayout;
- (void)setCollectionViewLayout:(id)arg1 animated:(BOOL)arg2 completion:(void (^)())completionHandler;
